...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference("Participation.count") do
      post participations_url, params: { participation: { anonymous: @participation.anonymous, bet_id: @participation.bet_id, fee: @participation.fee, message: @participation.message, owner_id: @participation.owner_id } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { anonymous: @participation.anonymous, bet_id: @participation.bet_id, fee: @participation.fee, message: @participation.message, owner_id: @participation.owner_id } }
